...
<head>
    ...
    <meta property="twitter:image" content="{{ !empty($settings['meta_seo_image']) ? fetch_file($settings['meta_seo_image'],'upload/seo') : '#' }}">
                    ...
                    <div class="row align-items-center g-4">
                        @if ($is3 % 2 != 0)
                            <div class="col-md-6 text-center mb-md-5">
                                ...
                                @else
                                    <img src="{{ Storage::url('upload/homepage/img-customize-1.svg') }}" alt="img"
                            ...
                            <div class="col-md-6 text-center mb-md-5">
                                @if (!empty($Section_1_content_value['Box' . $is3 . '_image_path']))
                                    <img src="{{ asset(Storage::url($Section_1_content_value['Box' . $is3 . '_image_path'])) }}"
                                        alt="img" class="img-fluid w-75" />
                                @else
                                    <img src="{{ Storage::url('upload/homepage/img-customize-2.svg') }}" alt="img"
                                        class="img-fluid w-75" />
                                @endif
                            </div>
                        @endif
                ...
                <div class="container">
                    <div class="row justify-content-center title">
                        <div class="col-md-9 col-lg-6 text-center">
                            ...
                            <h3 class="text-danger">{{ __('Note') }} : {{ __('All data shown here is dummy data provided to help clients better understand the features, functionality, and workflow of the platform') }}</h3>
                            @endif
                                ...
                                <div class="card price-card ">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush product-list">
                                            ...
                                            <li class="list-group-item enable">{{ __('Document Limit') }}
                                                {{ $subscription->document_limit }}
                                            </li>
                                            @if ($subscription->enabled_document_history)
                                                <li class="list-group-item enable">{{ __('Enabled') }}
                                                    {{ __('Document History') }}</li>
                                            @else
                                                <li class="list-group-item">{{ __('Disable') }}
                                                    {{ __('Document History') }}</li>
                                            @endif
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3 d-none d-md-block">
                        <img src="{{ Storage::url('upload/homepage/img-bg-hand.png') }}" alt="img" class="img-fluid hand-img" />
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h4 class="my-3 text-white">
                            {{ !empty($Section_10_content_value['Sec10_title']) ? $Section_10_content_value['Sec10_title'] : 'About DRMS SaaS' }}
                        </h4>
