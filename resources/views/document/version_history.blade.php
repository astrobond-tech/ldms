                    ...
                    <div class="col-lg-9">
                        <div class="email-body">
                            @if (Gate::check('create version'))
                                        ...
                                        {{ Form::open(['route' => [$document_type_route.'.new.version', \Illuminate\Support\Facades\Crypt::encrypt($document->id)], 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
                                                            ...
                                                            <td>
                                                                @if (Gate::check('preview document'))
                                                                    <a class="avtar avtar-xs btn-link-info text-info"
                                                                        ...
                                                                        href="{{ !empty($version->document) ? fetch_file($version->document,'upload/document/') : '#' }}"
                                                                        target="_blank"> <i
