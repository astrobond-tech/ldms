                                        ...
                                        @foreach ($subscriptions as $subscription)
                                            <td class="text-center">
                                                @switch($feature)
                                                    ...
                                                    @break
                                                    @case(__('Document Limit'))
                                                        {{ $subscription->document_limit }}
                                                    @break
                                                    @case(__('Document History'))
                                ...
                                <tr>
                                    ...
                                    @foreach ($subscriptions as $subscription)
                                        <td class="text-center">
                                            ...
                                            {!! Form::open(['method' => 'DELETE', 'route' => ['subscriptions.destroy', encrypt($subscription->id)]]) !!}
                                            @can('edit pricing packages')
                                                <a class="avtar avtar-xs btn-link-secondary text-secondary customModal" data-bs-toggle="tooltip"
                                                    ...
                                                    data-url="{{ route('subscriptions.edit', encrypt($subscription->id)) }}"
