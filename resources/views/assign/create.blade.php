{{Form::open(array('url'=>'assign','method'=>'post', 'id' => 'assignForm'))}}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{Form::number('quantity', 1, array('class'=>'form-control', 'required'=>'required', 'min'=>'1', 'id' => 'quantity'))}}
        </div>
    </div>
</div>
    ...
    $('#document_id').select2({
        ...
        $.ajax({
            ...
            success: function(data) {
                let detailsHtml = '<h4>{{__("Document Details")}}</h4>';
                if(data.essential) {
