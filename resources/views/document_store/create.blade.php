{{ Form::open(['route' => 'document-store.store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            {{ Form::text('document_name', null, ['class' => 'form-control', 'placeholder' => __('Enter Document Name')]) }}
        </div>
        <div class="form-group col-md-6">
            <!-- Availability Type -->
            ...
            {{ Form::file('document_file', ['class' => 'form-control']) }}
        </div>
