...
(1, 'health ministry', 2, '2025-10-09 13:35:39', '2025-10-09 13:38:23'),
(2, 'secretariate', 2, '2025-10-09 13:39:04', '2025-10-09 13:39:04');
...
--
-- Table structure for table `document_essentials`
--

CREATE TABLE `document_essentials` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `document_id` bigint(20) UNSIGNED NOT NULL,
  `document_type` enum('book','document','paper_cutting') NOT NULL COMMENT 'Allowed: book | document | paper_cutting',
  `copies_total` int(11) DEFAULT 0,
  `copies_available` int(11) DEFAULT 0,
  `rack` varchar(191) DEFAULT NULL COMMENT 'Rack identifier',
  `shelf` varchar(191) DEFAULT NULL COMMENT 'Shelf identifier',
  `room` varchar(191) DEFAULT NULL,
  `cabinet` varchar(191) DEFAULT NULL,
  ...
  `newspaper_name` varchar(191) DEFAULT NULL,
  `clipping_date` date DEFAULT NULL,
  `headline` varchar(191) DEFAULT NULL,
  `section` varchar(191) DEFAULT NULL COMMENT 'e.g. education, health, economy',
  `forwarded_to` varchar(191) DEFAULT NULL COMMENT 'Officer/Department forwarded to',
  `doc_category` varchar(191) DEFAULT NULL COMMENT 'e.g. contract, memo, policy',
  `ref_number` varchar(191) DEFAULT NULL COMMENT 'Document reference number',
  `file_number` varchar(191) DEFAULT NULL,
  `latest_version_history_id` bigint(20) UNSIGNED DEFAULT NULL COMMENT 'FK to version_histories.id',
...
--
-- Table structure for table `document_issues`
--

CREATE TABLE `document_issues` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `document_id` bigint(20) UNSIGNED NOT NULL,
  `essential_id` bigint(20) UNSIGNED DEFAULT NULL,
  `user_id` bigint(20) UNSIGNED DEFAULT NULL COMMENT 'Who borrowed the item',
  `issued_by` bigint(20) UNSIGNED DEFAULT NULL COMMENT 'Who issued (librarian/admin)',
  `issue_date` datetime DEFAULT NULL,
  `due_date` datetime DEFAULT NULL,
  `return_date` datetime DEFAULT NULL,
  `status` varchar(40) NOT NULL DEFAULT 'issued' COMMENT 'issued|returned|overdue|lost|damaged',
  `quantity` int(11) NOT NULL DEFAULT 1,
  `returned_quantity` int(11) NOT NULL DEFAULT 0,
  `returned_to_location` varchar(191) DEFAULT NULL,
...
(1, 'What features does your software offer?', 'Our software provides a range of features including automation tools, real-time analytics, cloud-based access, secure data storage, seamless integrations, and customizable solutions tailored to your business needs.', 1, 1, '2025-10-09 11:49:34', '2025-10-09 11:49:34'),
(2, 'Is your software easy to use?', 'Yes! Our platform is designed to be user-friendly and intuitive, so your team can get started quickly without a steep learning curve.', 1, 1, '2025-10-09 11:49:34', '2025-10-09 11:49:34'),
(3, 'Can I integrate your software with my existing systems?', 'Absolutely! Our software is built to easily integrate with your current tools and systems, making the transition seamless and efficient.', 1, 1, '2025-10-09 11:49:34', '2025-10-09 11:49:34'),
(4, 'Is customer support available?', 'Yes! We offer 24/7 customer support. Our dedicated team is ready to assist you with any questions or issues you may have.', 1, 1, '2025-10-09 11:49:34', '2025-10-09 11:49:34'),
(5, 'Is my data secure with your software?', 'Yes. We use advanced encryption and data protection protocols to ensure your data is secure and private at all times.', 1, 1, '2025-10-09 11:49:34', '2025-10-09 11:49:34'),
(6, 'Can I customize the software to fit my business needs?', 'Yes! Our software is highly customizable to adapt to your unique workflows and requirements.', 1, 1, '2025-10-09 11:49:34', '2025-10-09 11:49:34'),
(7, 'What types of businesses can benefit from your software?', 'Our solutions are suitable for a wide range of industries, including retail, healthcare, finance, marketing, and more. We tailor our offerings to meet the specific needs of each business.', 1, 1, '2025-10-09 11:49:34', '2025-10-09 11:49:34'),
(8, 'Is there a free trial available?', 'Yes! We offer a free trial so you can explore the features and capabilities of our software before committing.', 1, 1, '2025-10-09 11:49:34', '2025-10-09 11:49:34'),
(9, 'Do I need technical expertise to use the software?', 'Not at all. Our software is designed for users of all skill levels. Plus, our support team is available to guide you through any setup or usage questions.', 1, 1, '2025-10-09 11:49:34', '2025-10-09 11:49:34'),
(10, 'How often is the software updated?', 'We regularly release updates to improve features, security, and overall performance, ensuring that you always have access to the latest technology.', 1, 1, '2025-10-09 11:49:34', '2025-10-09 11:49:34');
...
(9, '2023_07_23_051513_create_documents_table', 1),
(10, '2023_07_23_052655_create_categories_table', 1),
(11, '2023_07_23_052715_create_sub_categories_table', 1),
(12, '2023_07_23_105702_create_tags_table', 1),
(13, '2023_07_31_160008_create_document_comments_table', 1),
(14, '2023_07_31_170000_create_reminders_table', 1),
(15, '2023_08_01_161941_create_version_histories_table', 1),
(16, '2023_08_02_145848_create_share_documents_table', 1),
(17, '2023_08_03_172747_create_document_histories_table', 1),
(18, '2023_08_04_164513_create_logged_histories_table', 1),
(19, '2024_01_12_141909_create_coupons_table', 1),
(20, '2024_01_12_171136_create_coupon_histories_table', 1),
(21, '2024_02_17_052552_create_package_transactions_table', 1),
(22, '2024_11_25_115027_create_notifications_table', 1),
(23, '2024_11_29_061023_add_email_verification_token_to_users_table', 1),
(24, '2025_01_01_032920_create_f_a_q_s_table', 1),
(25, '2025_01_01_052842_create_pages_table', 1),
(26, '2025_01_01_115236_create_home_pages_table', 1),
(27, '2025_01_30_090542_create_auth_pages_table', 1),
(28, '2025_02_05_065605_add_twofa_secret_to_users_table', 1),
(29, '2025_07_24_094606_version20_filled', 1),
(30, '2025_07_24_114553_create_stages_table', 1),
(31, '2019_12_14_000001_create_personal_access_tokens_table', 2),
(32, '2025_10_09_211542_create_document_essentials', 2),
(33, '2025_10_09_211900_create_document_issues_table', 2),
(34, '2025_10_09_213018_update_documents_nullable_category_subcategory', 3),
(35, '2025_10_11_103116_update_published_year_column_type_in_document_essentials_table', 4),
(36, '2025_10_11_164055_add_quantity_and_returned_quantity_to_document_issues_table', 5);
...
(97, 'manage storage settings', 'web', '2025-10-09 13:32:52', '2025-10-09 13:32:52'),
(98, 'manage client', 'web', '2025-10-09 13:32:52', '2025-10-09 13:32:52'),
(99, 'create client', 'web', '2025-10-09 13:32:52', '2025-10-09 13:32:52'),
(100, 'edit client', 'web', '2025-10-09 13:32:52', '2025-10-09 13:32:52'),
(101, 'delete client', 'web', '2025-10-09 13:32:52', '2025-10-09 13:32:52'),
(102, 'show client', 'web', '2025-10-09 13:32:52', '2025-10-09 13:32:52'),
(103, 'manage Stage', 'web', '2025-10-09 13:32:52', '2025-10-09 13:32:52'),
(104, 'create Stage', 'web', '2025-10-09 13:32:52', '2025-10-09 13:32:52'),
(105, 'edit Stage', 'web', '2025-10-09 13:32:52', '2025-10-09 13:32:52'),
(106, 'delete Stage', 'web', '2025-10-09 13:32:52', '2025-10-09 13:32:52'),
(107, 'show Stage', 'web', '2025-10-09 13:32:52', '2025-10-09 13:32:52'),
(108, 'share documents', 'web', '2025-10-09 13:32:52', '2025-10-09 13:32:52'),
(109, 'archive document', 'web', '2025-10-09 13:32:52', '2025-10-09 13:32:52');
...
INSERT INTO `reminders` (`id`, `subject`, `message`, `date`, `time`, `assign_user`, `document_id`, `created_by`, `parent_id`, `created_at`, `updated_at`) VALUES
(1, 'Sunt adipisicing cil', 'iyghio', '2025-10-11', '19:55:00', '4', 1, 2, 2, '2025-10-11 04:52:39', '2025-10-11 04:52:39'),
(2, 'piyhb', ';kjb;', '2025-10-30', '20:56:00', '3', 0, 2, 2, '2025-10-11 04:52:56', '2025-10-11 04:52:56');
...
(1, 'super admin', 'web', 0, '2025-10-09 11:49:34', '2025-10-09 11:49:34'),
(2, 'owner', 'web', 1, '2025-10-09 11:49:34', '2025-10-09 11:49:34'),
(3, 'manager', 'web', 2, '2025-10-09 11:49:34', '2025-10-09 11:49:34'),
(4, 'employee', 'web', 2, '2025-10-09 11:49:35', '2025-10-09 11:49:35');
...
(7, 'app_name', 'AsstrobondTech', NULL, 2, NULL, NULL),
(8, 'company_logo', '2_logo.png', NULL, 2, NULL, NULL),
(9, 'company_favicon', '2_favicon.png', NULL, 2, NULL, NULL),
(10, 'company_light_logo', '2_light_logo.png', NULL, 2, NULL, NULL),
(12, 'copyright', '© 2025 All rights reserved. Designed and developed by Astrobond Tech', NULL, 2, NULL, NULL),
(13, 'FROM_NAME', 'mail.astrobondtech.com', 'smtp', 2, NULL, NULL),
(14, 'FROM_EMAIL', 'khalid@astrobondtech.com', 'smtp', 2, NULL, NULL),
(15, 'SERVER_DRIVER', 'smtp', 'smtp', 2, NULL, NULL),
(16, 'SERVER_HOST', 'mail.astrobondtech.com', 'smtp', 2, NULL, NULL),
(17, 'SERVER_PORT', '465', 'smtp', 2, NULL, NULL),
(18, 'SERVER_USERNAME', 'khalid@astrobondtech.com', 'smtp', 2, NULL, NULL),
(19, 'SERVER_PASSWORD', 'Kh@lid536800!!', 'smtp', 2, NULL, NULL),
(20, 'SERVER_ENCRYPTION', 'ssl', 'smtp', 2, NULL, NULL);
...
INSERT INTO `share_documents` (`id`, `user_id`, `document_id`, `start_date`, `end_date`, `parent_id`, `created_at`, `updated_at`) VALUES
(1, 7, 12, '2025-10-12', '2025-10-13', 2, '2025-10-11 09:20:37', '2025-10-11 09:20:37'),
(2, 9, 11, '2025-10-12', '2025-10-31', 2, '2025-10-11 12:13:29', '2025-10-11 12:13:29');
...
(1, 'Basic', 0.00, 'Monthly', -1, -1, 1, 1, '2025-10-09 11:49:35', '2025-10-09 12:59:01');
...
INSERT INTO `sub_categories` (`id`, `title`, `category_id`, `parent_id`, `created_at`, `updated_at`) VALUES
(1, 'books', 1, 2, '2025-10-09 13:36:03', '2025-10-09 13:36:03'),
(2, 'paper cutting', 1, 2, '2025-10-09 13:36:19', '2025-10-09 13:36:19'),
(3, 'documents', 1, 2, '2025-10-09 13:36:38', '2025-10-09 13:36:38');
...
(1, 'Super Admin', NULL, 'superadmin@gmail.com', 'super admin', 'avatar.png', NULL, NULL, 'english', NULL, NULL, 0, '2025-10-09 11:49:34', NULL, '$2y$10$dnYEBxJH584ktjjOsdRyWu2iZye5oXQe7IsbOlyTn4HKzftnBIlsa', NULL, 1, NULL, '2025-10-09 11:49:34', '2025-10-09 11:49:34'),
(2, 'Owner', NULL, 'owner@gmail.com', 'owner', 'avatar.png', NULL, NULL, 'english', 1, '2025-11-09', 1, '2025-10-09 11:49:34', NULL, '$2y$10$mB11Yy1D6kVqZ2oehMWCuu90AUS0wap4Cy9toDMeYkVh1c3ny3DiG', NULL, 1, NULL, '2025-10-09 11:49:34', '2025-10-09 11:49:34'),
(3, 'Manager', NULL, 'manager@gmail.com', 'manager', 'avatar.png', NULL, NULL, 'english', 0, NULL, 2, '2025-10-09 11:49:35', NULL, '$2y$10$FOSlGupyqb84jsT45NavVOyHqQsPsiWH1cLG8JAs1Nj5r5SRNppBa', NULL, 1, NULL, '2025-10-09 11:49:35', '2025-10-09 11:49:35'),
(4, 'Employee', NULL, 'employee@gmail.com', 'employee', 'avatar.png', NULL, NULL, 'english', 0, NULL, 2, '2025-10-09 11:49:35', NULL, '$2y$10$7YUKq9.clSZxiqoXBHZx5eReZia2aUmga1H0mgiPSwjOObwexYNTy', NULL, 1, NULL, '2025-10-09 11:49:35', '2025-10-09 11:49:35'),
(7, 'faruk', 'ahmed', 'faruk@astrobondtech.com', 'client', NULL, '01100000000', 'kallyanpur, Dhaka', 'english', 1, NULL, 2, '2025-10-09 15:52:12', NULL, '$2y$10$mB11Yy1D6kVqZ2oehMWCuu90AUS0wap4Cy9toDMeYkVh1c3ny3DiG', NULL, 1, NULL, '2025-10-09 15:52:12', '2025-10-09 15:52:12'),
(8, 'harun', 'ur rashid', 'harun@astrobondtech.com', 'client', NULL, '12345567', NULL, 'english', 1, NULL, 2, '2025-10-09 16:02:34', NULL, '$2y$10$hUMmbyyZE61neAPvu9VJjOdELXrh.o/3fuSwDd5mqdYOWpbKHNgeG', NULL, 1, NULL, '2025-10-09 16:02:34', '2025-10-09 16:02:34'),
(9, 'khalid', 'wd', 'khalidsaiffullah28@gmail.com', 'client', NULL, NULL, NULL, 'english', 1, NULL, 2, '2025-10-11 09:56:26', NULL, '$2y$10$eUUjuHbWKz0dqGV2/EAlPeHjacMFqlls6.fs9DHcKqlbWXOCyfAW6', NULL, 1, NULL, '2025-10-11 09:56:26', '2025-10-11 12:12:58');
...
INSERT INTO `version_histories` (`id`, `document`, `current_version`, `document_id`, `created_by`, `parent_id`, `created_at`, `updated_at`) VALUES
(1, 'Screenshot from 2025-10-09 20-39-36_1760038831.png', '1', '1', 2, 2, '2025-10-09 13:40:31', '2025-10-09 13:40:31'),
(2, 'Screenshot from 2025-10-09 20-39-36_1760045196.png', '1', '2', 2, 2, '2025-10-09 15:26:36', '2025-10-09 15:26:36'),
(3, 'DRMS SaaS -     Paper Cutting_1760195986.pdf', '1', '12', 2, 2, '2025-10-11 09:19:46', '2025-10-11 09:19:46'),
(4, 'Screenshot from 2025-10-11 04-14-24_1760197127.png', '1', '9', 2, 2, '2025-10-11 09:38:47', '2025-10-11 09:38:47'),
(5, 'logo2_1760206271.png', '0', '11', 2, 2, '2025-10-11 12:11:11', '2025-10-11 12:12:23'),
(6, 'section-bg_1760206343.png', '1', '11', 2, 2, '2025-10-11 12:12:23', '2025-10-11 12:12:23');
...
--
-- Indexes for table `document_essentials`
--
ALTER TABLE `document_essentials`
  ADD PRIMARY KEY (`id`),
  ADD KEY `document_essentials_document_id_foreign` (`document_id`),
  ADD KEY `document_essentials_latest_version_history_id_foreign` (`latest_version_history_id`),
  ADD KEY `document_essentials_responsible_person_id_foreign` (`responsible_person_id`),
  ADD KEY `document_essentials_document_type_newspaper_name_index` (`document_type`,`newspaper_name`),
  ADD KEY `document_essentials_document_type_author_index` (`document_type`,`author`),
  ADD KEY `document_essentials_document_type_doc_category_index` (`document_type`,`doc_category`),
  ADD KEY `document_essentials_document_type_index` (`document_type`);
...
--
-- Indexes for table `document_issues`
--
ALTER TABLE `document_issues`
  ADD PRIMARY KEY (`id`),
  ADD KEY `document_issues_essential_id_foreign` (`essential_id`),
  ADD KEY `document_issues_user_id_foreign` (`user_id`),
  ADD KEY `document_issues_issued_by_foreign` (`issued_by`),
  ADD KEY `document_issues_document_id_user_id_status_index` (`document_id`,`user_id`,`status`);
...
--
-- AUTO_INCREMENT for table `document_essentials`
--
ALTER TABLE `document_essentials`
...
--
-- AUTO_INCREMENT for table `document_issues`
--
ALTER TABLE `document_issues`
...
--
-- Constraints for table `document_essentials`
--
ALTER TABLE `document_essentials`
  ADD CONSTRAINT `document_essentials_document_id_foreign` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `document_essentials_latest_version_history_id_foreign` FOREIGN KEY (`latest_version_history_id`) REFERENCES `version_histories` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `document_essentials_responsible_person_id_foreign` FOREIGN KEY (`responsible_person_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `document_issues`
--
ALTER TABLE `document_issues`
  ADD CONSTRAINT `document_issues_document_id_foreign` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `document_issues_essential_id_foreign` FOREIGN KEY (`essential_id`) REFERENCES `document_essentials` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `document_issues_issued_by_foreign` FOREIGN KEY (`issued_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `document_issues_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;
