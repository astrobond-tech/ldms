...
class SettingController extends Controller
{
    ...
    //             $noteFilenameWithExt = $request->file('logo')->getClientOriginalName();
    //             $noteFilename = pathinfo($noteFilenameWithExt, PATHINFO_FILENAME);
    //             $noteExtension = $request->file('logo')->getClientOriginalExtension();
    //             $fileName = $superadminLogoName;
    //             $directory = storage_path('upload/logo');

    //             $dir = 'upload/logo';
    //             $path = save_file($request, 'logo', $fileName, $dir, []);
    //             if ($path['flag'] == 0) {
    ...
    //             $noteFilenameWithExt = $request->file('landing_logo')->getClientOriginalName();
    //             $noteFilename = pathinfo($noteFilenameWithExt, PATHINFO_FILENAME);
    //             $noteExtension = $request->file('landing_logo')->getClientOriginalExtension();
    //             $fileName = $superadminLogoName;
    //             $directory = storage_path('upload/logo');

    //             $dir = 'upload/logo';
    //             $path = save_file($request, 'landing_logo', $fileName, $dir, []);
    //             if ($path['flag'] == 0) {
    //                 return redirect()->back()->with('error', __($path['msg']));
    //             }
    //         }
    ...
    //             $noteFilenameWithExt = $request->file('favicon')->getClientOriginalName();
    //             $noteFilename = pathinfo($noteFilenameWithExt, PATHINFO_FILENAME);
    //             $noteExtension = $request->file('favicon')->getClientOriginalExtension();
    //             $fileName = $superadminLogoName;
    //             $directory = storage_path('upload/logo');

    //             $dir = 'upload/logo';
    //             $path = save_file($request, 'favicon', $fileName, $dir, []);
    //             if ($path['flag'] == 0) {
    //                 return redirect()->back()->with('error', __($path['msg']));
    //             }
    //         }
    ...
    //             $noteFilenameWithExt = $request->file('light_logo')->getClientOriginalName();
    //             $noteFilename = pathinfo($noteFilenameWithExt, PATHINFO_FILENAME);
    //             $noteExtension = $request->file('light_logo')->getClientOriginalExtension();
    //             $fileName = $superadminLogoName;
    //             $directory = storage_path('upload/logo');

    //             $dir = 'upload/logo';
    //             $path = save_file($request, 'light_logo', $fileName, $dir, []);
    //             if ($path['flag'] == 0) {
    //                 return redirect()->back()->with('error', __($path['msg']));
    //             }
    //         }
