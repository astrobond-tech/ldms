                ...
                <div class="col-sm-12">
                    <div class="card border">
                        <div class="card-body text-center">
                            <h3><?php echo e(__('Enter Document Password')); ?></h3>
                            <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <div class="text-danger"><b><?php echo e($message); ?></b></div>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                            <form method="POST"
                                action="<?php echo e(route('document.validatePassword', ['id' => encrypt($id), 'data' => request()->data])); ?>">
                                <?php echo csrf_field(); ?>
                                <input type="password" name="password" class="form-control w-50 mx-auto my-3" placeholder="Document Password" required>
...
<?php /**PATH /home/khalid/Desktop/codecanyon-49249517-digital-document-saas-addon/main_file/resources/views/document/password.blade.php ENDPATH**/ ?>