                                        ...
                                        <?php if(Gate::check('edit FAQ') || Gate::check('delete FAQ')): ?>
                                            <td>
                                                <div class="cart-action">
                                                    <?php echo Form::open(['method' => 'DELETE', 'route' => ['FAQ.destroy', encrypt($item->id)]]); ?>
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit FAQ')): ?>
                                                        <a class="avtar avtar-xs btn-link-secondary text-secondary customModal" data-bs-toggle="tooltip"
                                                            ...
                                                            href="#" data-url="<?php echo e(route('FAQ.edit', encrypt($item->id))); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\main_file\resources\views/FAQ/index.blade.php ENDPATH**/ ?>