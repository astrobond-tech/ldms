            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <div class="price-card2">
                        <?php
                            $features = [__('User Limit'),__('Document Limit'),__('Document History'), __('Enabled Logged History'), __('Coupon Applicable')];
                        ?>
                                        ...
                                        <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td class="text-center">
                                                <?php switch($feature):
                                                    ...
                                                    <?php break; ?>
                                                    <?php case (__('Document Limit')): ?>
                                                        <?php echo e($subscription->document_limit); ?>

                                                    <?php break; ?>
                                                    <?php case (__('Document History')): ?>
                                ...
                                <tr>
                                    ...
                                    <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <td class="text-center">
                                            ...
                                            <?php echo Form::open(['method' => 'DELETE', 'route' => ['subscriptions.destroy', encrypt($subscription->id)]]); ?>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit pricing packages')): ?>
                                                <a class="avtar avtar-xs btn-link-secondary text-secondary customModal" data-bs-toggle="tooltip"
                                                    ...
                                                    data-url="<?php echo e(route('subscriptions.edit', encrypt($subscription->id))); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khalid/Desktop/codecanyon-49249517-digital-document-saas-addon/main_file/resources/views/subscription/index.blade.php ENDPATH**/ ?>