                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <?php if(Gate::check('edit note')): ?>
                                                                <a class="dropdown-item customModal" href="#"
                                                                    data-url="<?php echo e(route('note.edit', encrypt($note->id))); ?>"
                                                                    data-title="<?php echo e(__('Edit Note')); ?>"> <i
                                                                        class="ti ti-edit"></i><?php echo e(__('Edit')); ?></a>
                                                            <?php endif; ?>
                                                            <?php if(Gate::check('delete note')): ?>
                                                                <?php echo Form::open(['method' => 'DELETE', 'route' => ['note.destroy', encrypt($note->id)], 'id' => 'user-' . $note->id]); ?>
                                                            ...
                                                            <?php if(!empty($note->attachment)): ?>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(!empty($note->attachment) ? fetch_file($note->attachment,'upload/note/') : '#'); ?>" download>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khalid/Desktop/codecanyon-49249517-digital-document-saas-addon/main_file/resources/views/note/index.blade.php ENDPATH**/ ?>