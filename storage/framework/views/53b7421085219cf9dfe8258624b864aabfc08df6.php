                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <?php if(Gate::check('edit contact')): ?>
                                                                <a class="dropdown-item customModal" href="#" data-url="<?php echo e(route('contact.edit', encrypt($contact->id))); ?>"
                                                                    data-title="<?php echo e(__('Edit Contact')); ?>">   <i class="ti ti-edit"></i><?php echo e(__('Edit')); ?></a>

                                                            <?php endif; ?>
                                                            <?php if(Gate::check('delete contact')): ?>
                                                            <?php echo Form::open(['method' => 'DELETE', 'route' => ['contact.destroy', encrypt($contact->id)],'id'=>'user-'.$contact->id]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khalid/Desktop/codecanyon-49249517-digital-document-saas-addon/main_file/resources/views/contact/index.blade.php ENDPATH**/ ?>