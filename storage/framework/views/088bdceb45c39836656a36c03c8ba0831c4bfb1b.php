        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                ...
                <?php if(Gate::check('manage document') ||
                    ...
                    <?php if(Gate::check('manage document')): ?>
                        <li
                            class="pc-item <?php echo e(in_array($routeName, ['document.index', 'document.show', 'document.comment', 'document.reminder', 'document.version.history', 'document.share', 'document.send.email', 'document.archive']) ? 'active' : ''); ?>">
                        ...
                        <li class="pc-item <?php echo e(in_array($routeName, ['document-store.index']) ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('document-store.index')); ?>" class="pc-link">
                                <span class="pc-micon"><i data-feather="file-text"></i></span>
                                <span class="pc-mtext"><?php echo e(__('Documents Store')); ?></span>
                            </a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if(Gate::check('manage document history') && !empty($subscription) && $subscription->enabled_document_history == 1): ?>
                        <li class="pc-item <?php echo e(Request::route()->getName() == 'document.history' ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('paper-cutting.index')); ?>" class="pc-link">
                                <span class="pc-micon"><i data-feather="wind"></i></span>
                                <span class="pc-mtext"><?php echo e(__('All Paper Cutting')); ?></span>
                            </a>
                        </li>
                    <?php endif; ?>
                ...
                <?php if(Gate::check('manage category') ||
                   ...
                   <!--   <li class="pc-item pc-caption">
                    ...
                    <?php endif; ?>
                    <?php if(Gate::check('manage Pepar Cuting')): ?>
...
<?php /**PATH D:\xampp\htdocs\bdtech\ldms\resources\views/admin/menu.blade.php ENDPATH**/ ?>