            ...
            <div class="card table-card">
                <div class="card-header">
                    <div class="row align-items-center g-2 flex-wrap">
                        ...
                        <?php if(Gate::check('create book-assign')): ?>
                            <div class="col-12 col-md-auto">
                                <form action="" method="get">
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <?php if(Gate::check('archive book-assign')): ?>
                                            <div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khalid/Documents/ldms/resources/views/book_assign/index.blade.php ENDPATH**/ ?>