<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/select2/select2.css')); ?>">
    ...
    <?php else: ?>
        <link rel="stylesheet" id="Pstylesheet" href="<?php echo e(asset('assets/css/style-preset.css?n')); ?><?php echo e(time()); ?>" />
    <?php endif; ?>
...
<?php /**PATH /home/khalid/Desktop/codecanyon-49249517-digital-document-saas-addon/main_file/resources/views/admin/head.blade.php ENDPATH**/ ?>