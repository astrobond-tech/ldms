                ...
                <div class="card-header">
                    <div class="row align-items-center g-2">
                        ...
                        <?php if(Gate::check('create role')): ?>
                            <div class="col-auto">
                                <a class="btn btn-secondary" href="<?php echo e(route('role.create')); ?>"> <i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="cart-action">
                                                <?php echo Form::open(['method' => 'DELETE', 'route' => ['role.destroy', encrypt($role->id)]]); ?>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit role')): ?>
                                                    <a class="avtar avtar-xs btn-link-secondary text-secondary"
                                                        ...
                                                        href="<?php echo e(route('role.edit', encrypt($role->id))); ?>"> <i
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khalid/Desktop/codecanyon-49249517-digital-document-saas-addon/main_file/resources/views/role/index.blade.php ENDPATH**/ ?>