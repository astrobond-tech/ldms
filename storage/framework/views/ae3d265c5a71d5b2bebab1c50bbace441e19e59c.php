                                    ...
                                    <div class="col-auto">
                                        <?php if(Gate::check('create reminder')): ?>
                                            <a class="btn btn-secondary btn-sm ml-20 customModal" href="#"
                                                data-size="lg"
                                                data-url="<?php echo e(route($document_type_route.'.add.reminder', $document->id)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khalid/Documents/ldms/resources/views/document/reminder.blade.php ENDPATH**/ ?>