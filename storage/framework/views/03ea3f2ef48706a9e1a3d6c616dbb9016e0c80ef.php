                                        ...
                                        <?php if(Gate::check('edit Page') || Gate::check('delete Page')): ?>
                                            <td>
                                                <div class="cart-action">
                                                    <?php echo Form::open(['method' => 'DELETE', 'route' => ['pages.destroy', encrypt($item->id)]]); ?>
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show Page')): ?>
                                                        <a class="avtar avtar-xs btn-link-warning text-warning customModal" data-bs-toggle="tooltip"
                                                            data-size="xl" data-bs-original-title="<?php echo e(__('Show')); ?>"
                                                            href="#" data-url="<?php echo e(route('pages.show', encrypt($item->id))); ?>"
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit Page')): ?>
                                                        <a class="avtar avtar-xs btn-link-secondary text-secondary customModal" data-bs-toggle="tooltip"
                                                            ...
                                                            href="#" data-url="<?php echo e(route('pages.edit', encrypt($item->id))); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\main_file\resources\views/Pages/index.blade.php ENDPATH**/ ?>