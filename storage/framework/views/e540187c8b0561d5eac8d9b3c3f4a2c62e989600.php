                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription_key => $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <ul class="gap-2 mt-3 plan_change_info customCheckdef<?php echo e($subscription_key); ?>"
                                                            ...
                                                            <li><?php echo e(__('Document Limit')); ?> <?php echo e($subscription->document_limit); ?>

                                                            </li>
                                                            <?php if($subscription->enabled_document_history): ?>
                                                                <li><?php echo e(__('Enabled')); ?> <?php echo e(__('Document History')); ?></li>
                                                            <?php else: ?>
                                                                <li><?php echo e(__('Disable')); ?> <?php echo e(__('Document History')); ?></li>
                                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khalid/Desktop/codecanyon-49249517-digital-document-saas-addon/main_file/resources/views/user/show.blade.php ENDPATH**/ ?>