                    ...
                    <div class="col-lg-9">
                        <div class="email-body">
                            <?php if(Gate::check('create version')): ?>
                                        ...
                                        <?php echo e(Form::open(['route' => ['document.new.version', \Illuminate\Support\Facades\Crypt::encrypt($document->id)], 'method' => 'post', 'enctype' => 'multipart/form-data'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khalid/Desktop/codecanyon-49249517-digital-document-saas-addon/main_file/resources/views/document/version_history.blade.php ENDPATH**/ ?>