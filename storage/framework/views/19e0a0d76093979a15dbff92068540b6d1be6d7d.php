                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
							<a href="<?php echo e(route('book-assign.index')); ?>">
								<p class="mb-1"><?php echo e(__('Total Books')); ?></p>
								<div class="d-flex align-items-center justify-content-between">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <a href="<?php echo e(route('document.my-document')); ?>"><p class="mb-1"><?php echo e(__('Today Books')); ?></p>
                                <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <a href="<?php echo e(route('document.index')); ?>"><p class="mb-1"><?php echo e(__('Total Pepar Cuting')); ?></p>
                                <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <a href="<?php echo e(route('document.my-document')); ?>"><p class="mb-1"><?php echo e(__('Today Pepar Cuting')); ?></p>
                                <div class="d-flex align-items-center justify-content-between">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khalid/Documents/ldms/resources/views/dashboard/index.blade.php ENDPATH**/ ?>