            ...
            <ul class="pc-navbar">
                ...
                <?php if(Gate::check('manage document') ||
                    ...
                    <?php if(Gate::check('manage client')): ?>
                        <li
                            class="pc-item <?php echo e(in_array(Request::route()->getName(), ['client', 'client.show']) ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('client')); ?>" class="pc-link">
                                <span class="pc-micon"><i data-feather="user"></i></span>
                                <span class="pc-mtext"><?php echo e(__('Clients')); ?></span>
                            </a>
                        </li>
                    <?php endif; ?>
                    <?php if(Gate::check('manage document') || Gate::check('manage my document')): ?>
                        <li class="pc-item pc-hasmenu <?php echo e(str_starts_with($routeName, 'document.') ? 'pc-trigger active' : ''); ?>">
                            <a href="#!" class="pc-link">
                                <span class="pc-micon">
                            ...
                            <ul class="pc-submenu" style="display: <?php echo e(str_starts_with($routeName, 'document.') ? 'block' : 'none'); ?>">
                                <?php if(Gate::check('manage document')): ?>
                                    <li class="pc-item <?php echo e(in_array($routeName, ['document.index', 'document.show']) ? 'active' : ''); ?>">
                                        <a class="pc-link" href="<?php echo e(route('document.index')); ?>"><?php echo e(__('All Documents')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if(Gate::check('manage my document')): ?>
                                    <li class="pc-item <?php echo e($routeName == 'document.my-document' ? 'active' : ''); ?>">
                                        <a class="pc-link" href="<?php echo e(route('document.my-document')); ?>"><?php echo e(__('My Documents')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                    ...
                    <?php if(Gate::check('manage document') || Gate::check('manage my document')): ?>
                        <li class="pc-item pc-hasmenu <?php echo e(str_starts_with($routeName, 'book.') ? 'pc-trigger active' : ''); ?>">
                            <a href="#!" class="pc-link">
                                <span class="pc-micon">
                                    <i data-feather="book"></i>
                                </span>
                                <span class="pc-mtext"><?php echo e(__('Books')); ?></span>
                                <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
                            </a>
                            <ul class="pc-submenu" style="display: <?php echo e(str_starts_with($routeName, 'book.') ? 'block' : 'none'); ?>">
                                <?php if(Gate::check('manage document')): ?>
                                    <li class="pc-item <?php echo e(in_array($routeName, ['book.index', 'book.show']) ? 'active' : ''); ?>">
                                        <a class="pc-link" href="<?php echo e(route('book.index')); ?>"><?php echo e(__('All Books')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if(Gate::check('manage my document')): ?>
                                    <li class="pc-item <?php echo e($routeName == 'book.my-document' ? 'active' : ''); ?>">
                                        <a class="pc-link" href="<?php echo e(route('book.my-document')); ?>"><?php echo e(__('My Books')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                    ...
                    <?php if(Gate::check('manage document') || Gate::check('manage my document')): ?>
                        <li class="pc-item pc-hasmenu <?php echo e(str_starts_with($routeName, 'paper-cutting.') ? 'pc-trigger active' : ''); ?>">
                            <a href="#!" class="pc-link">
                                <span class="pc-micon">
                                    <i data-feather="scissors"></i>
                                </span>
                                <span class="pc-mtext"><?php echo e(__('Paper Cuttings')); ?></span>
                                <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
                            </a>
                            <ul class="pc-submenu" style="display: <?php echo e(str_starts_with($routeName, 'paper-cutting.') ? 'block' : 'none'); ?>">
                                <?php if(Gate::check('manage document')): ?>
                                    <li class="pc-item <?php echo e(in_array($routeName, ['paper-cutting.index', 'paper-cutting.show']) ? 'active' : ''); ?>">
                                        <a class="pc-link" href="<?php echo e(route('paper-cutting.index')); ?>"><?php echo e(__('All Paper Cuttings')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if(Gate::check('manage my document')): ?>
                                    <li class="pc-item <?php echo e($routeName == 'paper-cutting.my-document' ? 'active' : ''); ?>">
                                        <a class="pc-link" href="<?php echo e(route('paper-cutting.my-document')); ?>"><?php echo e(__('My Paper Cuttings')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                ...
                <?php if(Gate::check('manage category') ||
                    ...
                    <?php if(Gate::check('manage Stage')): ?>
                        <li class="pc-item <?php echo e(Request::route()->getName() == 'Stage.index' ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('Stage.index')); ?>" class="pc-link">
                                <span class="pc-micon"><i data-feather="grid"></i></span>
                                <span class="pc-mtext"><?php echo e(__('Document Stage')); ?></span>
                            </a>
                        </li>
                    <?php endif; ?>
                    <?php if(Gate::check('manage category')): ?>
...
<?php /**PATH /home/khalid/Documents/ldms/resources/views/admin/menu.blade.php ENDPATH**/ ?>