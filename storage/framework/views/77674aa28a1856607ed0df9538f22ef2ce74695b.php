<?php echo e(Form::model($book, ['route' => ['book-store.update', $book->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data'])); ?>
...
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-md-6">
            <?php echo e(Form::label('book_name', __('Book Name'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::text('book_name', null, ['class' => 'form-control', 'placeholder' => __('Enter Book Name')])); ?>
        ...
        <div class="form-group col-md-12">
            ...
            <?php echo e(Form::select('availability_type', ['offline' => __('Offline Only'), 'online' => __('Online Only'), 'both' => __('Both (Offline & Online)')], null, ['class' => 'form-control', 'id' => 'availabilityType', 'required'])); ?>
        ...
        <div class="form-group col-md-6">
            <?php echo e(Form::label('book_file', __('Book File'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::file('book_file', ['class' => 'form-control'])); ?>

            <?php if(!empty($book->book_file)): ?>
                <small>Current file: <a href="<?php echo e(asset('uploads/books/'.$book->book_file)); ?>" target="_blank"><?php echo e($book->book_file); ?></a></small>
            <?php endif; ?>
        </div>
...
<div class="modal-footer">
    <?php echo e(Form::submit(__('Update Book'), ['class' => 'btn btn-secondary btn-rounded'])); ?>

    <button type="button" class="btn btn-light btn-rounded" data-bs-dismiss="modal"><?php echo e(__('Cancel')); ?></button>
</div>
<?php echo e(Form::close()); ?>

<?php /**PATH D:\xampp\htdocs\bdtech\ldms\resources\views/book_store/edit.blade.php ENDPATH**/ ?>