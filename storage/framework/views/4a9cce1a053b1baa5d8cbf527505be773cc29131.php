...
<?php
    if (\Auth::user()->type == 'super admin') {
        ...
        $main_light_logo = getSettingsValByName('company_light_logo');
    }
...
<?php $__env->startPush('script-page'); ?>
    <script>
        $('.storage_switch').on('click mousedown', function(e) {
            e.stopPropagation();
        });
    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khalid/Desktop/codecanyon-49249517-digital-document-saas-addon/main_file/resources/views/settings/index.blade.php ENDPATH**/ ?>