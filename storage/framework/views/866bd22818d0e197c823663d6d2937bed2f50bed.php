...
<script>
    ...
    $(document).on('click', '.genarate_link', function() {
        $.ajax({
            url: '<?php echo e(route('generate.shareable.link')); ?>',
            type: 'GET',
            data: {
...
<?php /**PATH /home/khalid/Desktop/codecanyon-49249517-digital-document-saas-addon/main_file/resources/views/document/Sharelink.blade.php ENDPATH**/ ?>