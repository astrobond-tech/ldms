...
<head>
    ...
    <meta property="twitter:image" content="<?php echo e(!empty($settings['meta_seo_image']) ? fetch_file($settings['meta_seo_image'],'upload/seo') : '#'); ?>">


    <link rel="icon" href="<?php echo e(!empty($settings['company_favicon']) ? fetch_file($settings['company_favicon'],'upload/logo') : '#'); ?>" type="image/x-icon" />
                    ...
                    <div class="row align-items-center g-4">
                        <?php if($is3 % 2 != 0): ?>
                            <div class="col-md-6 text-center mb-md-5">
                                ...
                                <?php else: ?>
                                    <img src="<?php echo e(Storage::url('upload/homepage/img-customize-1.svg')); ?>" alt="img"
                            ...
                            <div class="col-md-6 text-center mb-md-5">
                                <?php if(!empty($Section_1_content_value['Box' . $is3 . '_image_path'])): ?>
                                    <img src="<?php echo e(asset(Storage::url($Section_1_content_value['Box' . $is3 . '_image_path']))); ?>"
                                        alt="img" class="img-fluid w-75" />
                                <?php else: ?>
                                    <img src="<?php echo e(Storage::url('upload/homepage/img-customize-2.svg')); ?>" alt="img"
                                        class="img-fluid w-75" />
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                ...
                <div class="container">
                    <div class="row justify-content-center title">
                        <div class="col-md-9 col-lg-6 text-center">
                            ...
                            <h3 class="text-danger"><?php echo e(__('Note')); ?> : <?php echo e(__('All data shown here is dummy data provided to help clients better understand the features, functionality, and workflow of the platform')); ?></h3>
                            <?php endif; ?>
                                ...
                                <div class="card price-card ">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush product-list">
                                            ...
                                            <li class="list-group-item enable"><?php echo e(__('Document Limit')); ?>

                                                <?php echo e($subscription->document_limit); ?>

                                            </li>
                                            <?php if($subscription->enabled_document_history): ?>
                                                <li class="list-group-item enable"><?php echo e(__('Enabled')); ?>

                                                    <?php echo e(__('Document History')); ?></li>
                                            <?php else: ?>
                                                <li class="list-group-item"><?php echo e(__('Disable')); ?>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3 d-none d-md-block">
                        <img src="<?php echo e(Storage::url('upload/homepage/img-bg-hand.png')); ?>" alt="img" class="img-fluid hand-img" />
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h4 class="my-3 text-white">
                            <?php echo e(!empty($Section_10_content_value['Sec10_title']) ? $Section_10_content_value['Sec10_title'] : 'About DRMS SaaS'); ?>
...
<?php /**PATH /home/khalid/Desktop/codecanyon-49249517-digital-document-saas-addon/main_file/resources/views/layouts/landing.blade.php ENDPATH**/ ?>