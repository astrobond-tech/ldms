                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="cart-action">
                                                <?php echo Form::open(['method' => 'DELETE', 'route' => ['users.destroy', encrypt($user->id)]]); ?>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show user')): ?>
                                                    <a class="avtar avtar-xs btn-link-warning text-warning"
                                                        ...
                                                        href="<?php echo e(route('users.show', encrypt($user->id))); ?>">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit user')): ?>
                                                    <a class="avtar avtar-xs btn-link-secondary text-secondary customModal"
                                                        ...
                                                        data-url="<?php echo e(route('users.edit', encrypt($user->id))); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khalid/Desktop/codecanyon-49249517-digital-document-saas-addon/main_file/resources/views/user/index.blade.php ENDPATH**/ ?>