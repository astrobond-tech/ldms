                                        ...
                                        <?php if(Gate::check('edit coupon') || Gate::check('delete coupon')): ?>
                                            <td class="text-right">
                                                <div class="cart-action">
                                                    <?php echo Form::open(['method' => 'DELETE', 'route' => ['coupons.destroy', encrypt($coupon->id)]]); ?>
                                                    ...
                                                    <?php if(Gate::check('edit coupon')): ?>
                                                        <a class="avtar avtar-xs btn-link-secondary text-secondary customModal" data-bs-toggle="tooltip"
                                                            ...
                                                            href="#"
                                                            data-url="<?php echo e(route('coupons.edit', encrypt($coupon->id))); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/khalid/Desktop/codecanyon-49249517-digital-document-saas-addon/main_file/resources/views/coupon/index.blade.php ENDPATH**/ ?>