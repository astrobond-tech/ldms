...
<?php echo e(Form::model($document, array('route' => array($document_type_route.'.update', encrypt($document->id)), 'method' => 'PUT','enctype' => "multipart/form-data"))); ?>
...
<div class="modal-body">
    ...
    <div class="row" id="book_fields" style="display: none;">
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('author',optional($document->essential)->author,array('class'=>'form-control','placeholder'=>__('Enter author')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('publisher',__('Publisher'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::text('publisher',optional($document->essential)->publisher,array('class'=>'form-control','placeholder'=>__('Enter publisher')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('isbn',__('ISBN'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::text('isbn',optional($document->essential)->isbn,array('class'=>'form-control','placeholder'=>__('Enter ISBN')))); ?>
    ...
    <div class="row" id="paper_cutting_fields" style="display: none;">
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('newspaper_name',optional($document->essential)->newspaper_name,array('class'=>'form-control','placeholder'=>__('Enter newspaper name')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('clipping_date',__('Clipping Date'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::date('clipping_date',optional($document->essential)->clipping_date,array('class'=>'form-control'))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('headline',__('Headline'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::text('headline',optional($document->essential)->headline,array('class'=>'form-control','placeholder'=>__('Enter headline')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('section',__('Section'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::text('section',optional($document->essential)->section,array('class'=>'form-control','placeholder'=>__('Enter section')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('forwarded_to',__('Forwarded To'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::text('forwarded_to',optional($document->essential)->forwarded_to,array('class'=>'form-control','placeholder'=>__('Enter forwarded to')))); ?>
    ...
    <div class="row" id="document_fields" style="display: none;">
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('doc_category',optional($document->essential)->doc_category,array('class'=>'form-control','placeholder'=>__('Enter document category')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('ref_number',__('Reference Number'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::text('ref_number',optional($document->essential)->ref_number,array('class'=>'form-control','placeholder'=>__('Enter reference number')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('file_number',__('File Number'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::text('file_number',optional($document->essential)->file_number,array('class'=>'form-control','placeholder'=>__('Enter file number')))); ?>
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::number('copies_total',optional($document->essential)->copies_total,array('class'=>'form-control','placeholder'=>__('Enter total copies')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('copies_available',__('Available Copies'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::number('copies_available',optional($document->essential)->copies_available,array('class'=>'form-control','placeholder'=>__('Enter available copies')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('rack',__('Rack'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::text('rack',optional($document->essential)->rack,array('class'=>'form-control','placeholder'=>__('Enter rack')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('shelf',__('Shelf'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::text('shelf',optional($document->essential)->shelf,array('class'=>'form-control','placeholder'=>__('Enter shelf')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('room',__('Room'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::text('room',optional($document->essential)->room,array('class'=>'form-control','placeholder'=>__('Enter room')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('cabinet',__('Cabinet'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::text('cabinet',optional($document->essential)->cabinet,array('class'=>'form-control','placeholder'=>__('Enter cabinet')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('language',__('Language'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::text('language',optional($document->essential)->language,array('class'=>'form-control','placeholder'=>__('Enter language')))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('published_year',__('Published Year'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::number('published_year',optional($document->essential)->published_year,array('class'=>'form-control','placeholder'=>__('Enter published year')))); ?>
...
</script><?php /**PATH /home/khalid/Documents/ldms/resources/views/document/edit.blade.php ENDPATH**/ ?>