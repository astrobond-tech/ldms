...
--
-- Host: localhost
-- Generation Time: Oct 08, 2025 at 09:44 PM
...
CREATE TABLE `book` (
  ...
  `book-file` varchar(355) NOT NULL,
...
CREATE TABLE `book_store` (
  ...
  `book-file` varchar(355) DEFAULT NULL,
  `availability_type` varchar(50) NOT NULL DEFAULT 'offline' COMMENT 'offline, online, or both',
  `description` text DEFAULT NULL,
  `room_no` int(11) NOT NULL,
  `rack_no` int(11) NOT NULL,
  `shelf_no` int(11) NOT NULL,
...
INSERT INTO `book_store` (`id`, `book_name`, `parent_id`, `book-file`, `availability_type`, `description`, `room_no`, `rack_no`, `shelf_no`, `box_no`, `created_by`, `created_at`, `user_id`, `updated_at`) VALUES
(2, 'demo 103', NULL, '1759956096_Support_ticket_management.pdf', 'offline', 'dcn\'', 123, 1, 1, 1, 2, '2025-10-08 20:40:02', 2, '2025-10-08 20:48:30'),
(3, 'fcku', NULL, '1759959356_a2iServerforD-nothiE-nothisystem_2.pdf', 'both', 'jgvh', 123, 1, 1, 1, 2, '2025-10-08 21:35:56', 2, '2025-10-08 21:35:56');
...
CREATE TABLE `paper_cuttings` (
  `id` int(11) NOT NULL,
  `paper_name` varchar(388) NOT NULL,
  `parent_id` int(11) NOT NULL,
  `papercutting_file` varchar(388) NOT NULL,
  `heading` varchar(388) NOT NULL,
  `room_no` int(11) NOT NULL,
  `rack_no` int(11) NOT NULL,
  `shelf_no` int(11) NOT NULL,
  `box_no` int(11) NOT NULL,
...
(1, 'Super Admin', NULL, 'superadmin@gmail.com', 'super admin', 'avatar_1758744320.png', NULL, NULL, 'english', NULL, NULL, 0, '2025-09-24 13:20:22', NULL, '$2y$10$oOT1Bo3SwRtiT6yn4XDW1.CFF6dLP61Bxb/3I3Svz3qN1xssFSB0G', NULL, 1, NULL, '2025-09-24 13:20:22', '2025-09-24 14:05:20'),
(2, 'Owner', NULL, 'owner@gmail.com', 'owner', 'avatar.png', NULL, NULL, 'english', 1, '2025-10-24', 1, '2025-09-24 13:20:22', NULL, '$2y$10$QPkgv8sKG.PYYYLSdC5WS.WSO25g.8xl1tlVk0Q2y09dkGEP20rBW', NULL, 1, NULL, '2025-09-24 13:20:22', '2025-09-24 13:20:22'),
(3, 'Manager', NULL, 'manager@gmail.com', 'manager', 'avatar.png', NULL, NULL, 'english', 0, NULL, 2, '2025-09-24 13:20:22', NULL, '$2y$10$oIRL/bnufIxFzn0YVJbs7eeIM5QTvMAqpzPevKtC7V14/EJefQx9e', NULL, 1, NULL, '2025-09-24 13:20:22', '2025-09-24 13:20:22'),
(4, 'Employee', NULL, 'employee@gmail.com', 'employee', 'avatar.png', NULL, NULL, 'english', 0, NULL, 2, '2025-09-24 13:20:23', NULL, '$2y$10$Hd7WcxYfz8DHtxhCXskBhemM2lBqtvwVTWEcvvrpPJDfOai3WKDwe', NULL, 1, NULL, '2025-09-24 13:20:23', '2025-09-24 13:20:23'),
(5, 'khalid', 'Syffullah', 'khalid@gmail.com', 'employee', 'avatar.png', '01301361854', NULL, 'english', NULL, NULL, 2, '2025-10-08 12:12:30', NULL, '$2y$10$FKg/4uFpV1olQgPxxmvl1ecCh9an9cwejJIIgt4Veteu3B4nkZK6O', NULL, 1, NULL, '2025-10-08 12:12:30', '2025-10-08 12:12:30');
...
ALTER TABLE `book_store`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_availability_type` (`availability_type`),
